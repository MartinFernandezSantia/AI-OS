...
| **2** | **WhatsApp / Chatwoot** | "el de Chatwoot para TG", "automatización de WhatsApp para TG" | Terminal Gráfica | Cliente | ✅ **Sí — VENDIDO (~fin jun-2026)**: USD 400 desarrollo + mantenimiento USD 30/mes o USD 300/año (moneda asumida USD — confirmar) | **EN VIVO desde 31-08-2026** — bot Excel+LLM (rediseño, ver `project-context/TerminalGrafica/whatsapp-rag/HANDOFF.md`), reemplazó a v10 y RAG-lite (archivados en `project-context/TerminalGrafica/archives/`) | Prod = **Hostinger KVM 4 a nombre de TG**. WhatsApp Cloud API + API de IA a cuentas de TG. ⚠️ Desde el 1-oct-2026 Meta cobra los mensajes de servicio (pass-through de TG — avisar por escrito). |
