...
const A3 = agente(
  ...
  [
    ...
    '  - A cada elegido le pones confianza 0..1 segun cuan seguro estas de que es',
    '    lo que el cliente pidio (no cuan lindo es el producto).',
    '  - Si NINGUNO corresponde de verdad, devolve la lista vacia. Es una respuesta',
    '    valida y correcta: mejor derivar a un humano que cotizar otra cosa.',
    ...
    '    candidatos son genericos, bajá la confianza y marcá `dudaNicho: true`.',
  ].join('\n'),
  {
    type: 'object',
    required: ['elegidos'],
...
const A4 = agente(
  ...
  [
    ...
    '  no lo multiplicas por la cantidad, no calculas totales, no estimas.',
    '  Si el cliente pide un total que no esta en los hechos, decis que se lo',
    '  confirmamos por mail. NUNCA lo calculas vos.',
    '',
    'VOZ:',
