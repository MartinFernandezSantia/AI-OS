...
export const PRODUCTOS = [
  ...
  // ── Papelería comercial ──────────────────────────────────────────────────────────────
  { coleccion: "Papelería comercial", producto: "500 hojas membretadas A4", material: "Hojas membretadas A4 x500", formato: "A4", descripcion: "Hojas A4 impresas con el logo y los datos del negocio. El precio es por las 500.", sinonimos: "hojas membretadas, papel con logo, membrete" },
  ...
  { coleccion: "Papelería comercial", producto: "10 talonarios de factura o remito", material: "Talonarios x10", formato: "A5", descripcion: "10 talonarios A5 de 50 juegos por duplicado, abrochados y troquelados. El precio es por los 10 talonarios.", sinonimos: "talonarios, facturas, remitos, notas de pedido, comandas" },
  ...
  { coleccion: "Papelería comercial", producto: "Carpetas institucionales", material: "Carpetas institucionales sin laminar", formato: "A4 cerrada", descripcion: "Carpeta de presentación A4 cerrada, en cartulina 300 g, troquelada, con solapa y ranura. Sin laminar. Se cobra por unidad.", sinonimos: "carpetas, carpetas de presentación, folders" },
  { coleccion: "Papelería comercial", producto: "Carpetas institucionales laminadas", material: "Carpetas institucionales laminadas", formato: "A4 cerrada", descripcion: "La misma carpeta A4, plastificada: más resistente al uso y al roce." },
  { coleccion: "Papelería comercial", producto: "Recetarios en negro", material: "Recetarios en negro", formato: "A5 o A6", descripcion: "Talonario de recetas impreso en negro. Mínimo 5 unidades.", sinonimos: "recetarios, recetas médicas, blocks de receta" },
  { coleccion: "Papelería comercial", producto: "Recetarios en color", material: "Recetarios en color", formato: "A5 o A6", descripcion: "Talonario de recetas impreso full color. Mínimo 5 unidades." },

  // ── Impresión digital ────────────────────────────────────────────────────────────────
  { coleccion: "Impresión digital", producto: "Impresión color A4", material: "Impresión color A4 simple faz", formato: "A4", descripcion: "Impresión full color en papel obra 75 g, de un lado. Se cobra por hoja y el precio baja por cantidad.", sinonimos: "imprimir, impresiones, copias en color" },
  { coleccion: "Impresión digital", producto: "Impresión color A4 doble faz", material: "Impresión color A4 doble faz", formato: "A4", descripcion: "Full color de los dos lados de la hoja." },
  { coleccion: "Impresión digital", producto: "Impresión blanco y negro A4", material: "Impresión blanco y negro A4 simple faz", formato: "A4", descripcion: "Impresión en blanco y negro en papel obra 75 g, de un lado. Se cobra por hoja.", sinonimos: "imprimir, impresiones, impresión de archivos, fotocopias" },
  { coleccion: "Impresión digital", producto: "Impresión blanco y negro A4 doble faz", material: "Impresión blanco y negro A4 doble faz", formato: "A4", descripcion: "Blanco y negro de los dos lados de la hoja. Es lo que se usa para apuntes y material de estudio: se cuentan las hojas y se le suma el anillado." },
  { coleccion: "Impresión digital", producto: "Impresión color A3", material: "Impresión color A3", formato: "A3", descripcion: "Impresión láser full color en A3. Se cobra por hoja." },
  { coleccion: "Impresión digital", producto: "Impresión blanco y negro A3", material: "Impresión blanco y negro A3", formato: "A3", descripcion: "Impresión en blanco y negro en A3. Se cobra por hoja." },
  { coleccion: "Impresión digital", producto: "Impresión en papel ilustración", material: "Impresión en papel ilustración", formato: "A4", descripcion: "Papel ilustración: más grueso y con terminación satinada." },
  { coleccion: "Impresión digital", producto: "Impresión en opalina", material: "Impresión en opalina", formato: "A4", descripcion: "Opalina: papel rígido y liso, para certificados y diplomas." },

  // ── Encuadernación y terminaciones ───────────────────────────────────────────────────
  { coleccion: "Encuadernación y terminaciones", producto: "Anillado plástico", material: "Anillado plástico", formato: "A4 u oficio", descripcion: "Anillado con espiral plástico. Se cobra por unidad y no incluye la impresión.", sinonimos: "anillado, espiralado, espiral, encuadernado con anillo" },
  { coleccion: "Encuadernación y terminaciones", producto: "Anillado metálico wire-o", material: "Anillado metálico wire-o", formato: "A4 o A3", descripcion: "Anillado con espiral metálico wire-o. No incluye la impresión." },
  { coleccion: "Encuadernación y terminaciones", producto: "Encuadernación abrochada a caballo", material: "Encuadernación abrochada", formato: "A4", descripcion: "Abrochado al centro, para cuadernillos de pocas hojas. No incluye la impresión." },
  { coleccion: "Encuadernación y terminaciones", producto: "Encuadernación fresada", material: "Encuadernación fresada", formato: "A4", descripcion: "Encuadernación pegada, tipo libro. No incluye la impresión.", sinonimos: "encuadernación, empastado, tesis, libros" },
  { coleccion: "Encuadernación y terminaciones", producto: "Laminado mate o brillante", material: "Laminado", formato: "A4", descripcion: "Plastificado fino sobre el impreso, mate o brillante. Se cobra por unidad.", sinonimos: "laminado, plastificado, brillo, mate" },
  { coleccion: "Encuadernación y terminaciones", producto: "Plastificado de documentos A4", material: "Plastificado A4", formato: "A4", descripcion: "Plastificado rígido de documentos en A4. Se cobra por unidad.", sinonimos: "plastificado, laminado rígido, plastificar" },
  { coleccion: "Encuadernación y terminaciones", producto: "Plastificado de documentos oficio", material: "Plastificado oficio", formato: "oficio", descripcion: "Plastificado rígido en tamaño oficio." },
  { coleccion: "Encuadernación y terminaciones", producto: "Plastificado de documentos A3", material: "Plastificado A3", formato: "A3", descripcion: "Plastificado rígido en A3." },
  { coleccion: "Encuadernación y terminaciones", producto: "Plastificado de credencial o carnet 9x13", material: "Plastificado carnet", formato: "9x13 cm", descripcion: "Plastificado de credenciales y carnets, 9x13 cm.", sinonimos: "credencial, carnet, plastificar carnet" },
  ...
  // ── Folletería y editorial ───────────────────────────────────────────────────────────
  { coleccion: "Folletería y editorial", producto: "500 volantes A6", material: "Volantes A6 x500", formato: "A6 (10x15 cm)", descripcion: "Volantes 10x15 cm full color. El precio es por los 500.", sinonimos: "volantes, flyers, panfletos, folletos" },
  ...
  { coleccion: "Folletería y editorial", producto: "Anotadores personalizados", material: "Anotadores personalizados en negro", formato: "10x15 cm", descripcion: "Taco de anotador 10x15 cm impreso en negro. Se cobra por unidad.", sinonimos: "anotadores, tacos, blocks, libretas" },
  { coleccion: "Folletería y editorial", producto: "Anotadores personalizados en color", material: "Anotadores personalizados en color", formato: "10x15 cm", descripcion: "El mismo taco 10x15 cm, impreso full color." },

  // ── Gran formato y cartelería ────────────────────────────────────────────────────────
  { coleccion: "Gran formato y cartelería", producto: "Posters A3 y A2", material: "Posters A3 y A2", formato: "A3 o A2", descripcion: "Poster impreso full color, A3 o A2. Se cobra por unidad.", sinonimos: "posters, afiches, láminas" },
  ...
  { coleccion: "Señalética y punto de venta", producto: "Cartelería de seguridad e higiene A3", material: "Cartelería en plástico corrugado A3", formato: "A3", descripcion: "Carteles reglamentarios de seguridad e higiene, en A3 (29,7x42 cm) sobre plástico corrugado. Este precio es solo para el A3; en otra medida se cotiza como cartel.", sinonimos: "cartel de seguridad, señalética, higiene y seguridad, cartel reglamentario" },
  ...
  { coleccion: "Señalética y punto de venta", producto: "Señalética de baños y accesos A3", material: "Cartelería en plástico corrugado A3", formato: "A3", descripcion: "Señalética de baños y accesos en A3 sobre plástico corrugado. Para interior también se puede en A4 plastificado.", sinonimos: "señalética, cartel de baño, cartel de acceso, señal" },
  { coleccion: "Señalética y punto de venta", producto: "Cartas y menús plastificados A4", material: "Cartas y menús plastificados", formato: "A4", descripcion: "Carta o menú A4 impreso y plastificado, para que aguante el uso diario.", sinonimos: "cartas, menús, carta de restaurante" },
  { coleccion: "Señalética y punto de venta", producto: "Carteles de precios y ofertas A3", material: "Impresión color más plastificado", formato: "A3", descripcion: "Cartel de precios u ofertas en A3: impresión color más plastificado.", sinonimos: "cartel de precios, cartel de oferta, cartel para el local" },
